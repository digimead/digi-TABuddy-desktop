 ...
 */
trait OperationModifySortingList {
  checkSubclass()
   ...
   */
  def operation(graph: Graph[_ <: Model.Like], sortingList: Set[Sorting]): api.Operation[Set[Sorting]]
  ...
  protected def checkSubclass(): Unit =
    throw new IllegalAccessException("Please, use org.digimead.tabuddy.desktop.logic.operation.view.OperationModifySortingList instead.")
}
