...
object OperationModifySortingList extends Loggable {
  ...
  /** Bridge between abstract api.Operation[Set[Sorting]] and concrete Operation[Set[Sorting]] */
  abstract class Abstract(val sortingList: Set[Sorting], val modelId: Symbol)
    extends Operation[Set[Sorting]](s"Edit sorting list for model $modelId.") {
    this: Loggable =>
  }
  /**
  ...
  private object DI extends DependencyInjection.PersistentInjectable {
    lazy val operation = injectOptional[api.OperationModifySortingList]
  }
}
