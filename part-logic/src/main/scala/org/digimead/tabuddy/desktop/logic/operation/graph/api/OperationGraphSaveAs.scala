...
trait OperationGraphSaveAs {
   ...
   */
  def operation(graph: Graph[_ <: Model.Like], name: String, path: File, serialization: Option[Serialization.Identifier]): api.Operation[Graph[_ <: Model.Like]]
