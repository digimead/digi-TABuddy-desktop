 ...
 */
trait XOperationModifyView[T <: XView] {
  checkSubclass()
   ...
   */
  def apply(graph: Graph[_ <: Model.Like], view: T, viewList: Set[T]): XView
  /**
   ...
   */
  def operation(graph: Graph[_ <: Model.Like], view: T, viewList: Set[T]): XOperation[T]
