...
trait OperationModifyEnumerationList {
   ...
   */
  def apply(graph: Graph[_ <: Model.Like], enumerationList: Set[Enumeration[_ <: AnyRef with java.io.Serializable]]): Set[Enumeration[_ <: AnyRef with java.io.Serializable]]
  /**
   ...
   */
  def operation(graph: Graph[_ <: Model.Like], enumerationList: Set[Enumeration[_ <: AnyRef with java.io.Serializable]]): api.Operation[Set[Enumeration[_ <: AnyRef with java.io.Serializable]]]
