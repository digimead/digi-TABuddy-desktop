...
package org.digimead.tabuddy.desktop.logic.api

import java.io.File
import java.util.UUID

/** Model marker is an object that hold association between real model at client and Eclipse IResource within container(project). */
trait ModelMarker {
