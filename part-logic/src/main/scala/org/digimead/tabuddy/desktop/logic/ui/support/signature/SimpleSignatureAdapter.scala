...
import org.digimead.tabuddy.model.serialization.signature.{ Mechanism, SimpleSignature }
import org.eclipse.swt.widgets.{ Composite, Shell }

/**
 * Adapter between model.serialization.signature.SimpleSignature and UI
 */
class SimpleSignatureAdapter extends SignatureAdapter {
  ...
  def composite(parent: Composite, default: Option[Mechanism.Parameters]) = None
