 ...
 */
trait OperationModifyEnumeration {
  checkSubclass()
  ...
  def apply(graph: Graph[_ <: Model.Like], enumeration: Enumeration[_ <: AnyRef with java.io.Serializable],
    enumerationList: Set[Enumeration[_ <: AnyRef with java.io.Serializable]]): Enumeration[_ <: AnyRef with java.io.Serializable]
  /**
  ...
  def operation(graph: Graph[_ <: Model.Like], enumeration: Enumeration[_ <: AnyRef with java.io.Serializable],
    enumerationList: Set[Enumeration[_ <: AnyRef with java.io.Serializable]]): api.Operation[Enumeration[_ <: AnyRef with java.io.Serializable]]
  ...
  protected def checkSubclass(): Unit =
    throw new IllegalAccessException("Please, use org.digimead.tabuddy.desktop.logic.operation.OperationModifyEnumeration instead.")
}
