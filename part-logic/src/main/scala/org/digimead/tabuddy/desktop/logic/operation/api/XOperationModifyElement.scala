...
trait XOperationModifyElement {
  ...
  /**
   * Create 'Modify an element' operation.
   *
   * @param element element for modification
   * @return 'Modify an element' operation
   */
  def operation(element: Element): XOperation[Element]
  ...
  protected def checkSubclass(): Unit =
    throw new IllegalAccessException("Please, use org.digimead.tabuddy.desktop.logic.operation.OperationModifyElement instead.")
}
