...
import org.digimead.tabuddy.desktop.logic.payload.api.{ PropertyType, TemplateProperty }
...
trait Comparator[T <: Comparator.Argument] {
  ...
  def compare[U <: AnyRef with java.io.Serializable](property: TemplateProperty[U], e1: Element, e2: Element, argument: Option[T]): Int =
    compare(property.id, property.ptype, e1, e2, argument)
  /** Compare two element's properties */
  def compare[U <: AnyRef with java.io.Serializable](propertyId: Symbol, ptype: PropertyType[U], e1: Element, e2: Element, argument: Option[T]): Int
