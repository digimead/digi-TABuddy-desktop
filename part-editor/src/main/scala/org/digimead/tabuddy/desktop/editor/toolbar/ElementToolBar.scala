...
package org.digimead.tabuddy.desktop.editor.toolbar
 ...
 */
class ElementToolBar extends Resources.ResourceToolBarSubscriber(classOf[ElementToolBar].getName()) with Actor with Loggable {
...
object ElementToolBar {
  ...
  private object DI extends DependencyInjection.PersistentInjectable {
    /** ElementToolBar actor reference configuration object. */
    lazy val props = injectOptional[Props]("ElementToolBar") getOrElse Props[ElementToolBar]
  }
}
