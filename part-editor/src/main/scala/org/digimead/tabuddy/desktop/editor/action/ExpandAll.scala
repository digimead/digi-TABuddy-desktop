...
/** Expand all elements. */
class ExpandAll extends JFaceAction("ExpandAll") with Loggable {
...
/*
class ExpandAll extends Handler(ExpandAll) with Loggable {
  @log
...
object ExpandAll extends Handler.Singleton with Loggable {
  /** ExpandAll actor path. */
  lazy val actorPath = App.system / Core.id / Editor.id / EditorToolBar.id / id
  /** Command id for the current handler. */
  val commandId = classOf[ExpandAll].getName
  /** Handler actor reference configuration object. */
  val props = DI.props

  class Behavoiur extends Handler.Behaviour(ExpandAll) with Loggable
  /**
   * Dependency injection routines
   */
  private object DI extends DependencyInjection.PersistentInjectable {
    /** ExpandAll actor reference configuration object. */
    lazy val props = injectOptional[Props]("command.ExpandAll") getOrElse Props[Behavoiur]
  }
}
*/
