 ...
 */
class JobCreateElement(override val container: Element.Generic, override val modelID: Symbol)
  extends org.digimead.tabuddy.desktop.logic.job.JobCreateElement(container, modelID) with Loggable {
