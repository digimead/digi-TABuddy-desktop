...
public class ElementTemplateEditorSkel extends TitleAreaDialog {
	...
	private static ResourceBundle getResourceBundle() {
		try {
			...
			return ResourceBundle.getBundle("org.digimead.tabuddy.desktop.model.definition.dialog.eltemed.messages");
	...
	protected Control createDialogArea(Composite parent) {
		setMessage(BUNDLE.getString("elementTemplateEditorDescription_text")); //$NON-NLS-1$
		setTitle(BUNDLE.getString("elementTemplateEditorTitle_text"));
