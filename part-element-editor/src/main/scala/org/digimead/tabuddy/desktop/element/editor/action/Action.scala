...
class Action extends Actor with Loggable {
  ...
  /*
   * Element editor component action's actors.
   */
  val createElementActionRef = context.actorOf(ActionCreateElement.props, ActionCreateElement.id)
...
object Action {
  ...
  private object DI extends DependencyInjection.PersistentInjectable {
    /** Action actor reference configuration object. */
    lazy val props = injectOptional[Props]("ElementEditor.Action") getOrElse Props[Action]
  }
}
