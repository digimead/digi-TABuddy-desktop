...
import org.digimead.tabuddy.desktop.model.editor.Wizards.configurator2implementation
...
object Editor {
  ...
  object Id {
    ...
    final val stateOfToggleEmpty = "org.digimead.tabuddy.desktop.model.editor.Editor/stateOfToggleEmpty"
    /** Value of the ToggleExpand switch [java.lang.Boolean]. */
    final val stateOfToggleExpand = "org.digimead.tabuddy.desktop.model.editor.Editor/stateOfToggleExpand"
    /** Value of the ToggleIdentificator switch [java.lang.Boolean]. */
    final val stateOfToggleIdentificator = "org.digimead.tabuddy.desktop.model.editor.Editor/stateOfToggleIdentificator"
    /** Value of the ToggleSystem switch [java.lang.Boolean]. */
    final val stateOfToggleSystem = "org.digimead.tabuddy.desktop.model.editor.Editor/stateOfToggleSystem"
  }
  /**
