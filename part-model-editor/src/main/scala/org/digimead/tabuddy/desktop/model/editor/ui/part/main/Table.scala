...
//  protected[main] lazy val content = WritableList[TreeProxy.Item]
...
//  protected[main] def createColumns(columns: mutable.LinkedHashSet[String], columnsWidth: Map[String, Int]) {
...
//  protected[main] def onSortingChanged() {
//    tableViewer.getComparator.asInstanceOf[Table.TableComparator].sorted = None
//    tableViewer.refresh()
//  }
//}
...
//  protected[main] var columnLabelProvider = immutable.HashMap[String, Table.TableLabelProvider]()
//
...
//    override def select(viewer: Viewer, parentElement: Object, element: Object): Boolean = false
...
//    protected[main] var sorted: Option[parallel.immutable.ParVector[TreeProxy.Item]] = None
...
//    def updateActionResetSorting() = {}
//    //table.get.foreach(table =>
...
//    /*App.findShell(e.widget).foreach(withContext(_) { (context, view) =>
