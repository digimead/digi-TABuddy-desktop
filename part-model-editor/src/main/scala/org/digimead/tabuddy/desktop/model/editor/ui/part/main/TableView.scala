...
package org.digimead.tabuddy.desktop.model.editor.part.main
//
...
//  protected[main] lazy val table = new Table(this, SWT.BORDER | SWT.FULL_SELECTION | SWT.V_SCROLL)
//  protected[main] lazy val tree = new Tree(this, SWT.BORDER | SWT.FULL_SELECTION | SWT.V_SCROLL)
//  //protected[main] lazy val proxy = new TreeProxy(tree.treeViewer, Seq(table.content), tree.context.expandedItems)
...
//
//  /** Clear root path */
//  protected[main] def clearRootElement() {
...
//  override protected[main] def getCoolBarManager(): CoolBarManager = super.getCoolBarManager()
//  /** Allow external access for scala classes */
//  override protected[main] def getSashForm() = super.getSashForm
//  /** Initialize table view */
...
//        case Some(item) if item.hash != 0 =>
//          // TODO fieldElement
//          //Data.fieldElement.value = item.element
//        case _ =>
...
//  // TODO fieldElement
//  protected[main] def updateActiveElement(element: Element.Generic) {// = Data.fieldElement.value) {
...
//  }
//  /** Update root path */
//  protected[main] def updateRootElement(element: Element.Generic) {
...
//  /** The column special identifier */
//  protected[main] val COLUMN_NAME = "name"
