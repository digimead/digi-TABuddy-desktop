 ...
 * @author ezh
 */
public class FilterEditor extends TitleAreaDialog {
	 ...
	 * @param parentShell
	 */
	public FilterEditor(Shell parentShell) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		textFilterFilters.setToolTipText(Messages.lookupFilter_text);
		...
		tableColumnInversion.setText(Messages.inversion_text);
		...
		tableColumnFilter.setText(Messages.filter_text);
