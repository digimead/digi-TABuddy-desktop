...
package org.digimead.tabuddy.desktop.ui.dialog.model.typelist
...
class TypeList(val parentShell: Shell, val initial: List[TypeSchema.Interface], val initialActiveSchema: TypeSchema.Interface)
  extends org.digimead.tabuddy.desktop.res.dialog.model.TypeList(parentShell) with Dialog with Loggable {
