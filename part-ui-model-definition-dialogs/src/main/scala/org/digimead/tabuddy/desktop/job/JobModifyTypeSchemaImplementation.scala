...
import org.digimead.tabuddy.desktop.ui.dialog.model.typeed.TypeEditor
import org.digimead.tabuddy.model.Model
import org.digimead.tabuddy.model.Model.model2implementation
import org.eclipse.core.runtime.IAdaptable
import org.eclipse.core.runtime.IProgressMonitor

class JobModifyTypeSchemaImplementation(
  override val schema: TypeSchema.Interface,
  override val schemaList: Set[TypeSchema.Interface],
  override val isActive: Boolean,
  override val modelID: Symbol) extends JobModifyTypeSchema(schema, schemaList, isActive, modelID) {
