...
package org.digimead.tabuddy.desktop.ui.dialog.model.enumlist
...
class EnumerationList(val parentShell: Shell, val initial: List[Enumeration.Interface[_ <: AnyRef with java.io.Serializable]])
  extends org.digimead.tabuddy.desktop.res.dialog.model.EnumerationList(parentShell) with Dialog with Loggable {
