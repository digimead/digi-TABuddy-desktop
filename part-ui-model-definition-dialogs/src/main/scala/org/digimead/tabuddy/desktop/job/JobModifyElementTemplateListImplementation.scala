...
import org.digimead.tabuddy.desktop.ui.dialog.model.eltemlist.ElementTemplateList
 ...
 */
class JobModifyElementTemplateListImplementation(
  override val elementTemplates: Set[ElementTemplate.Interface],
  override val modelID: Symbol) extends JobModifyElementTemplateList(elementTemplates, modelID) with Loggable {
