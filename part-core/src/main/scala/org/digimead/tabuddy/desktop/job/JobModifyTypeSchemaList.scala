 ...
 */
abstract class JobModifyTypeSchemaList(val before: Set[TypeSchema.Interface], val active: TypeSchema.Interface, val modelID: Symbol)
  extends Job[(Set[TypeSchema.Interface], TypeSchema.Interface)]("Edit type schema list of model " + Model.eId)
