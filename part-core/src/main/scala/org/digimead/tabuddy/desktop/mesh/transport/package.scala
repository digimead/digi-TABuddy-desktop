...
package org.digimead.tabuddy.desktop.mesh
...
package object transport {
  lazy val default = new NewBindingModule(module => {
    module.bind[ExecutorService] identifiedBy "Transport" toSingle { Executors.newCachedThreadPool() }
    module.bind[Boolean] identifiedBy "Transport.NIO" toSingle { true }
