 ...
 */
abstract class JobModifyEnumerationList(val enumerationList: Set[Enumeration.Interface[_ <: AnyRef with java.io.Serializable]], val modelID: Symbol)
  extends Job[Set[Enumeration.Interface[_ <: AnyRef with java.io.Serializable]]]("Edit enumeration list of %s model".format(Model.eId))
