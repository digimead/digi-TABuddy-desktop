...
abstract class JobModifySortingList(val sortingList: Set[Sorting], val modelID: Symbol)
  extends Job[Set[Sorting]]("Edit enumeration list of %s model".format(Model.eId))
