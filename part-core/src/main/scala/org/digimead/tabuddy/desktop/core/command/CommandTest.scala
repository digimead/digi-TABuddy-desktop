...
object CommandTest extends XLoggable {
  import Command.parser._
  /** Akka execution context. */
  implicit lazy val ec = App.system.dispatcher
  /** Command description. */
  implicit lazy val descriptor = Command.Descriptor(UUID.randomUUID())("test", "my test", "my test\njust a test",
    (activeContext, parserContext, parserResult) ⇒ Future {
      val exchanger = new Exchanger[Operation.Result[String]]()
      OperationTest().foreach { operation ⇒
