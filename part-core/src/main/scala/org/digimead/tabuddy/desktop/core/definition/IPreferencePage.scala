...
import org.eclipse.jface.preference.{ IPreferencePage ⇒ EIPreferencePage, PreferenceManager }

/**
 * Application preference page interface.
 */
trait IPreferencePage extends EIPreferencePage with XPreferencePage {
