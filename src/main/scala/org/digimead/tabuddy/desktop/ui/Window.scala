...
import org.digimead.tabuddy.desktop.ui.action.ActionShowElementTemplateList
import org.digimead.tabuddy.desktop.ui.action.ActionShowEnumerationList
import org.digimead.tabuddy.desktop.ui.action.ActionShowTypeList
...
class Window extends org.digimead.tabuddy.desktop.res.Window with Loggable {
  ...
  // model
  getMenuModel.add(ActionShowElementTemplateList)
  getMenuModel.add(ActionShowEnumerationList)
  getMenuModel.add(ActionShowTypeList)
  // other
