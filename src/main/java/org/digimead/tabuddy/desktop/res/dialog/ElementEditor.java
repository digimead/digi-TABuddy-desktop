...
public class ElementEditor extends TitleAreaDialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		lblElementName = toolkit.createLabel(form.getBody(),
				Messages.name_text, SWT.NONE);
		lblElementName.setAlignment(SWT.RIGHT);
		lblElementName.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false,
				false, 2, 1));
	...
	protected Label getLblElementName() {
		return lblElementName;
	}
}
