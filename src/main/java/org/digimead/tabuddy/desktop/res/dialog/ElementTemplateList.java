...
public class ElementTemplateList extends TitleAreaDialog {
	private TableViewer tableElementTemplates;
	...
	protected Control createDialogArea(Composite parent) {
		...
		tableElementTemplates = new TableViewer(container, SWT.BORDER | SWT.CHECK | SWT.FULL_SELECTION);
		Table table_templates = tableElementTemplates.getTable();
		...
		tableViewerColumnAvailability = new TableViewerColumn(
				tableElementTemplates, SWT.NONE);
		...
		tableViewerColumnId = new TableViewerColumn(tableElementTemplates,
				SWT.NONE);
		TableColumn tblclmnId = tableViewerColumnId.getColumn();
		tblclmnId.setWidth(100);
		tblclmnId.setText(Messages.identificator_text);

		tableViewerColumnDescription = new TableViewerColumn(
				tableElementTemplates, SWT.NONE);
		TableColumn tblclmnDescription = tableViewerColumnDescription
				.getColumn();
		tblclmnDescription.setWidth(100);
		tblclmnDescription
				.setText(Messages.description_text);

		compositeTemplates = new Composite(container, SWT.NONE);
		compositeTemplates.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER,
				true, false, 1, 1));
		compositeTemplates.setLayout(new FlowLayout(FlowLayout.RIGHT, 5, 5));
	...
	protected TableViewer getTableElementTemplates() {
		return tableElementTemplates;
	}

	public Composite getCompositeTemplates() {
