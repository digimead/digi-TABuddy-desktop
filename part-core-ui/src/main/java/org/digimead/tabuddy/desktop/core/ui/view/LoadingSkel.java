 ...
 * @author ezh
 */
public class LoadingSkel extends Composite {
	 ...
	 * @param style
	 */
	public LoadingSkel(Composite parent, int style) {
		super(parent, style);
		...
		fd_container.top = new FormAttachment(30);
		fd_container.left = new FormAttachment(30);
		fd_container.right = new FormAttachment(70);
		fd_container.bottom = new FormAttachment(70);
