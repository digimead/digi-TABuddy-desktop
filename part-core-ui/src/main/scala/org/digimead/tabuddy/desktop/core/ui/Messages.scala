...
object Messages extends NLS with XLoggable {
  ...
  val default_text = ""
  val menu_dumpDescriptionLong_text = ""
  val menu_dumpDescriptionShort_text = ""
  val menu_dump_text = ""
  val menu_hideDescriptionLong_text = ""
  val menu_hideDescriptionShort_text = ""
  val menu_hide_text = ""
  val menu_showDescriptionLong_text = ""
  val menu_showDescriptionShort_text = ""
  val menu_show_text = ""
  val newWindow_text = ""
  val open_text = ""
