...
import org.eclipse.jface.viewers.{ CellLabelProvider, DecoratingStyledCellLabelProvider }
import org.eclipse.jface.viewers.{ IDecorationContext, ILabelDecorator }
import org.eclipse.jface.viewers.DelegatingStyledCellLabelProvider.IStyledLabelProvider
import org.eclipse.swt.graphics.{ Color, Font, Image, Point }

/**
 * DecoratingStyledCellLabelProvider that provides tooltip support.
 */
class DecoratingStyledCellLabelProviderExt(labelProvider: IStyledLabelProvider, decorator: ILabelDecorator, decorationContext: IDecorationContext)
