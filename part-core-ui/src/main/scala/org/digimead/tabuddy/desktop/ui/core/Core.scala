...
package org.digimead.tabuddy.desktop.ui.core
...
import org.digimead.tabuddy.desktop.ui.block.{ WindowMenu, WindowToolbar }
 ...
 */
class Core extends Actor with Loggable {
...
object Core {
  ...
  private object DI extends DependencyInjection.PersistentInjectable {
    /** Core actor reference configuration object. */
    lazy val props = injectOptional[Props]("Core.UI.Core") getOrElse Props[Core]
  }
}
