...
import org.digimead.tabuddy.desktop.core.ui.block.api.XConfiguration
...
trait XOperationViewCreate {
   ...
   * @param new view id
   */
  def apply(windowId: UUID, viewConfiguration: XConfiguration.CPlaceHolder): Option[UUID]
  /**
   ...
   */
  def operation(windowId: UUID, viewConfiguration: XConfiguration.CPlaceHolder): XOperation[UUID]
