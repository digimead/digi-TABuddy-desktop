 ...
 * @author ezh
 */
public class SortingList extends TitleAreaDialog {
	 ...
	 * @param parentShell
	 */
	public SortingList(Shell parentShell) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		setMessage(CustomMessages.viewSortingListDescription_text);
		setTitle(CustomMessages.viewSortingListTitle_text);
		...
		textFilter.setToolTipText(Messages.lookupFilter_text);
		textFilter.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true,
				false, 1, 1));
		textFilter.setMessage(Messages.lookupFilter_text);
		...
		tableColumnName.setText(Messages.name_text);
		...
		tableColumnDescription.setText(Messages.description_text);
