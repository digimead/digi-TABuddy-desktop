...
public class FilterEditorSkel extends TitleAreaDialog {
	...
	protected Control createDialogArea(Composite parent) {
		setMessage(CustomMessages.viewFilterEditorDescription_text);
		setTitle(CustomMessages.viewFilterEditorTitle_text);
		...
		lblName.setText(org.digimead.tabuddy.desktop.Messages$.MODULE$.name_text()); // $hide$
		...
		lblFilters.setText(org.digimead.tabuddy.desktop.Messages$.MODULE$.filters_text());

		textFilterProperties = new Text(container, SWT.BORDER);
		textFilterProperties.setToolTipText(org.digimead.tabuddy.desktop.Messages$.MODULE$.lookupFilter_text()); // $hide$
		textFilterProperties.setLayoutData(new GridData(SWT.FILL, SWT.CENTER,
				false, false, 1, 1));
		new Label(container, SWT.NONE);

		textFilterFilters = new Text(container, SWT.BORDER);
		textFilterFilters.setToolTipText(org.digimead.tabuddy.desktop.Messages$.MODULE$.lookupFilter_text()); // $hide$
		textFilterFilters.setLayoutData(new GridData(SWT.FILL, SWT.CENTER,
				true, false, 1, 1));
		...
		tableViewerColumnTypeFrom = new TableViewerColumn(
				tableViewerProperties, SWT.NONE);
		TableColumn tableColumnTypeFrom = tableViewerColumnTypeFrom.getColumn();
		tableColumnTypeFrom.setWidth(100);
		tableColumnTypeFrom.setText(org.digimead.tabuddy.desktop.Messages$.MODULE$.type_text()); // $hide$

		compositeBody = new Composite(container, SWT.NONE);
		compositeBody.setLayout(new GridLayout(1, false));

		tableViewerFilters = new TableViewer(container, SWT.BORDER
				| SWT.FULL_SELECTION);
		...
		tableViewerColumnProperty = new TableViewerColumn(tableViewerFilters,
				SWT.NONE);
		TableColumn tableColumnProperty = tableViewerColumnProperty.getColumn();
		tableColumnProperty.setWidth(100);
		tableColumnProperty.setText(org.digimead.tabuddy.desktop.Messages$.MODULE$.property_text()); // $hide$

		tableViewerColumnType = new TableViewerColumn(tableViewerFilters,
				SWT.NONE);
		TableColumn tableColumnType = tableViewerColumnType.getColumn();
		tableColumnType.setWidth(100);
		tableColumnType.setText(org.digimead.tabuddy.desktop.Messages$.MODULE$.type_text()); // $hide$

		tableViewerColumnInversion = new TableViewerColumn(tableViewerFilters,
				SWT.NONE);
		TableColumn tableColumnInversion = tableViewerColumnInversion
				.getColumn();
		tableColumnInversion.setWidth(100);
		tableColumnInversion.setText(org.digimead.tabuddy.desktop.Messages$.MODULE$.inversion_text()); // $hide$
		...
		tableColumnFilter.setText(org.digimead.tabuddy.desktop.Messages$.MODULE$.filter_text()); // $hide$

		tableViewerColumnArgument = new TableViewerColumn(tableViewerFilters,
				SWT.NONE);
		TableColumn tableColumnArgument = tableViewerColumnArgument.getColumn();
		tableColumnArgument.setWidth(100);
		tableColumnArgument.setText(org.digimead.tabuddy.desktop.Messages$.MODULE$.argument_text()); // $hide$
