...
package org.digimead.tabuddy.desktop.viewmod.dialog;
...
public class CustomMessages extends NLS {
	private static final String BUNDLE_NAME = "org.digimead.tabuddy.desktop.viewmod.dialog.messages"; //$NON-NLS-1$
