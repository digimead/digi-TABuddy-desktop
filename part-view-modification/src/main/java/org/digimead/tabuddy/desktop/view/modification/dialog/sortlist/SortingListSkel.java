 ...
 * @author ezh
 */
public class SortingListSkel extends TitleAreaDialog {
	...
	private static ResourceBundle getResourceBundle() {
		try {
			...
			return ResourceBundle.getBundle("org.digimead.tabuddy.desktop.view.modification.dialog.sortlist.messages");
	...
	protected Control createDialogArea(Composite parent) {
		setMessage(BUNDLE.getString("viewSortingListDescription_text"));
		setTitle(BUNDLE.getString("viewSortingListTitle_text"));
