...
public class SortingEditorSkel extends TitleAreaDialog {
	...
	protected Control createDialogArea(Composite parent) {
		setMessage(CustomMessages.viewSortingEditorDescription_text);
		setTitle(CustomMessages.viewSortingEditorTitle_text);
		...
		textFilterSortings.setToolTipText(org.digimead.tabuddy.desktop.Messages$.MODULE$.lookupFilter_text()); // $hide$
		textFilterSortings.setLayoutData(new GridData(SWT.FILL, SWT.CENTER,
				true, false, 1, 1));
		new Label(container, SWT.NONE);
		...
		tableViewerSortings = new TableViewer(container, SWT.BORDER
				| SWT.FULL_SELECTION);
		...
		tableViewerColumnN = new TableViewerColumn(tableViewerSortings,
				SWT.NONE);
		TableColumn tableColumnN = tableViewerColumnN.getColumn();
		tableColumnN.setWidth(100);
		tableColumnN.setText("N");

		tableViewerColumnProperty = new TableViewerColumn(tableViewerSortings,
				SWT.NONE);
		...
		tableViewerColumnType = new TableViewerColumn(tableViewerSortings,
				SWT.NONE);
		...
		tableViewerColumnDirection = new TableViewerColumn(tableViewerSortings,
				SWT.NONE);
		TableColumn tableColumnDirection = tableViewerColumnDirection
				.getColumn();
		tableColumnDirection.setWidth(100);
		tableColumnDirection.setText(org.digimead.tabuddy.desktop.Messages$.MODULE$.direction_text()); // $hide$
		...
		tableColumnSorting.setText(org.digimead.tabuddy.desktop.Messages$.MODULE$.sorting_text()); // $hide$

		tableViewerColumnArgument = new TableViewerColumn(tableViewerSortings,
				SWT.NONE);
