 ...
 * @author ezh
 */
public class SortingEditor extends TitleAreaDialog {
	 ...
	 * @param parentShell
	 */
	public SortingEditor(Shell parentShell) {
		super(parentShell);
	}
	...
	protected Control createDialogArea(Composite parent) {
		...
		lblName.setText(Messages.name_text);
		...
		textFilterProperties.setToolTipText(Messages.lookupFilter_text);
		textFilterProperties.setLayoutData(new GridData(SWT.FILL, SWT.CENTER,
				false, false, 1, 1));
		new Label(container, SWT.NONE);

		textFilterSortings = new Text(container, SWT.BORDER);
		textFilterSortings.setToolTipText(Messages.lookupFilter_text);
		...
		tableColumnTypeFrom.setText(Messages.type_text);
		...
		tableColumnProperty.setText(Messages.property_text);
		...
		tableColumnType.setText(Messages.type_text);
		...
		tableColumnDirection.setText(Messages.direction_text);
		...
		tableColumnSorting.setText(Messages.sorting_text);
		...
		tableColumnArgument.setText(Messages.argument_text);
