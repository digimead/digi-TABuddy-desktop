...
/** Modify filter list. */
//class ActionModifyFilterList private () extends JFaceAction(Messages.filters_text) with Loggable {
...
//    OperationModifyFilterList(Data.getAvailableViewFilters - Filter.allowAllFilter).foreach { operation =>
...
//}
//
//object ActionModifyFilterList extends Loggable {
//  /** Singleton identificator. */
//  val id = getClass.getSimpleName().dropRight(1)
//  /** ModifyFilterList action. */
//  @volatile protected var action: Option[ActionModifyFilterList] = None
//
//  /** Returns ModifyFilterList action. */
//  def apply(): ActionModifyFilterList = action.getOrElse {
//    val modifyFilterListAction = App.execNGet { new ActionModifyFilterList }
//    action = Some(modifyFilterListAction)
//    modifyFilterListAction
//  }
//  /** ModifyFilterList action actor reference configuration object. */
//  def props = DI.props
//
//  /** ModifyFilterList action actor. */
...
//    /** ModifyFilterList actor reference configuration object. */
//    lazy val props = injectOptional[Props]("ViewModification.Action.ModifyFilterList") getOrElse Props[ActionModifyFilterList.Actor]
//  }
//}
