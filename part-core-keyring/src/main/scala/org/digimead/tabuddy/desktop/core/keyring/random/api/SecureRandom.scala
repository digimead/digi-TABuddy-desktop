...
package org.digimead.tabuddy.desktop.core.keyring.random.api

import java.security.Provider

/**
 * Base trait for a cryptographically strong random number generator.
 */
abstract class SecureRandom extends java.security.SecureRandom {
  // java.util.Random
  ...
  override def setSeed(seed: Array[Byte])
}
